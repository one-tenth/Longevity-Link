# Generated by Django 5.2 on 2025-10-03 02:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Period', models.CharField(choices=[('morning', '早上'), ('evening', '晚上')], max_length=10)),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('UserID', 'LocalDate', 'Period'), name='uniq_user_localdate_period')],
            },
        ),
        migrations.CreateModel(
            name='LocaRecord',
            ...
            options={
                ...
                'ordering': ['-Timestamp'],
                'indexes': [models.Index(fields=['UserID', '-Timestamp'], name='mysite_loca_UserID_7cc438_idx')],
            },
        ),
    ]
